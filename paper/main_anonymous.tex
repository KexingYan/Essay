...
Evidence from Kiva}}
\author{Author information removed for blind review}
\date{\today}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/figure5_map_lending.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/figure6_map_gdp.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/figure7_map_institutions.pdf}
...
\input{tables/table3_country_linear.tex}
...
\input{tables/table3b_margins.tex}

\input{tables/table4_country_quadratic.tex}
...
\input{tables/table5b_margins.tex}

\input{tables/table6_loan_quadratic.tex}
...
\input{tables/table8_logit.tex}

\input{tables/table9_two_margins.tex}
...
\input{tables/table10_lind_mehlum.tex}
...
\input{tables/table11_sample_period.tex}
...
\input{tables/table12_loan_robustness.tex}

\input{tables/table13_loan_robustness_utest.tex}
...
\input{tables/table2_terciles.tex}
\input{tables/table5_loan_linear.tex}
\input{tables/table7_cluster_compare.tex}
\input{tables/tableA1_year_coverage.tex}
